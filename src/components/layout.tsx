    ...
    <div className="relative min-h-screen bg-background">
      ...
      <footer className="border-t border-border/70 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-4 dark:border-white/10">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>Made with 💗 by <a className="text-primary hover:text-primary/80 transition-colors" href="https://samiullahwaheedportfolio.netlify.app/" target="_blank" rel="noopener noreferrer">@SamiullahWaheed</a> </p>
        </div>
      </footer>
    </div>
  );
